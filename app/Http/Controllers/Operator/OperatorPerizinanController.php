...
class OperatorPerizinanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.perizinan.index', [
            'izins' => $izins,
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('operator.perizinan.create', [
            'users' => $users,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator-perizinan.index')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.perizinan.edit', [
            'users' => $users,
            'izins' => $izins,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('operator-perizinan.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('operator-perizinan.index')->with('success', 'Selamat ! Anda berhasil menghapus data');
    }
}
