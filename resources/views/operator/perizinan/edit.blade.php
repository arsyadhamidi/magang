...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ route('operator-perizinan.update', $izins->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('operator-perizinan.index') }}" class="btn btn-primary">
                                    ...
                                    <select name="users_id" class="form-control @error('users_id') is-invalid @enderror"
                                        ...
                                        @foreach ($users as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $izins->users_id == $data->id ? 'selected' : '' }}>
                                                {{ $data->name ?? '-' }}</option>
                                        @endforeach
                                    </select>
                                    @error('users_id')
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nama" name="nama" class="form-control @error('nama') is-invalid @enderror"
                                        value="{{ old('nama', $izins->nama ?? '') }}" placeholder="Masukkan nama lengkap">
                                    @error('nama')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="tmp_lahir" name="tmp_lahir"
                                        ...
                                        value="{{ old('tmp_lahir', $izins->tmp_lahir) }}" placeholder="Masukkan tempat lahir">
                                    @error('tmp_lahir')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="tgl_lahir" name="tgl_lahir"
                                        ...
                                        value="{{ old('tgl_lahir', $izins->tgl_lahir) }}">
                                    @error('tgl_lahir')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_mulai"
                                        ...
                                        value="{{ old('tgl_mulai', $izins->tgl_mulai) }}">
                                    @error('tgl_mulai')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tgl_selesai"
                                        ...
                                        value="{{ old('tgl_selesai', $izins->tgl_selesai) }}">
                                    @error('tgl_selesai')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select name="jk" id="selectedJekel"
                                        ...
                                        <option value="Laki-Laki" {{ $izins->jk == 'Laki-Laki' ? 'selected' : '' }}>
                                            Laki-Laki</option>
                                        <option value="Perempuan" {{ $izins->jk == 'Perempuan' ? 'selected' : '' }}>
                                            Perempuan</option>
                                    </select>
                                    @error('jk')
                                        <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="telp"
                                        ...
                                        value="{{ old('telp', $izins->telp) }}" placeholder="Masukkan nomor telepon">
                                    @error('telp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="universitas"
                                        ...
                                        value="{{ old('universitas', $izins->universitas ?? '') }}" placeholder="Masukkan universitas">
                                    @error('universitas')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="selectedStatus"
                                        ...
                                        <option value="Diterima" {{ $izins->status == 'Diterima' ? 'selected' : '' }}>
                                            Diterima</option>
                                        <option value="Proses" {{ $izins->status == 'Proses' ? 'selected' : '' }}>
                                            Proses</option>
                                        <option value="Ditolak" {{ $izins->status == 'Ditolak' ? 'selected' : '' }}>
                                            Ditolak</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="5"
                                        placeholder="Masukan alamat domisili">{{ old('alamat', $izins->alamat ?? '') }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
