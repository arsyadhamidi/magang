            ...
            <div class="mb-3">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('mahasiswa-perizinan.create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            @if ($data->status == 'Proses')
                                                <a href="{{ route('mahasiswa-perizinan.edit', $data->id) }}"
                                                ...
                                                <form action="{{ route('mahasiswa-perizinan.destroy', $data->id) }}"
                                                    method="POST">
                                                    @csrf
