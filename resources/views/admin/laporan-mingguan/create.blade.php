                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="nilai" id="selectedNilai"
                                        ...
                                        <option value="Sangat Baik" {{ old('nilai') == 'Sangat Baik' ? 'selected' : '' }}>
                                            Sangat Baik</option>
                                        <option value="Baik" {{ old('nilai') == 'Baik' ? 'selected' : '' }}>
                                            Baik</option>
                                        <option value="Cukup" {{ old('nilai') == 'Cukup' ? 'selected' : '' }}>
                                            Cukup</option>
                                        <option value="Kurang Baik" {{ old('nilai') == 'Kurang Baik' ? 'selected' : '' }}>
                                            Kurang Baik</option>
                                        <option value="Tidak Baik" {{ old('nilai') == 'Tidak Baik' ? 'selected' : '' }}>
                                            Tidak Baik</option>
                                    </select>
                                    @error('nilai')
                                        <div class="invalid-feedback">
