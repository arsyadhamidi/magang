...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="mb-3">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('pegawai-perizinan.index') }}" method="GET">
                            @csrf
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <div class="modal fade" id="editModal{{ $data->id }}"
                                                ...
                                                <form action="{{ route('pegawai-perizinan.update', $data->id) }}"
                                                    method="POST">
                                                    @csrf
                                            ...
                                            <form action="{{ route('pegawai-perizinan.destroy', $data->id) }}"
                                                method="POST">
                                                @csrf
    ...
    <div class="modal fade" id="tambahModal" aria-labelledby="tambahModalLabel" aria-hidden="true">
        <form action="{{ route('pegawai-perizinan.store') }}" method="POST">
            @csrf
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
